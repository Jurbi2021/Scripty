        ...
        >
          ...
          >
            ...
            <div className={styles.modalContent}>
              ...
              <Text as="p" className={styles.paragraph}>
                Esta é uma versão <b>Beta</b> e estamos a trabalhar para melhorar a cada dia. O seu feedback é muito valioso! Se encontrar algum problema ou tiver alguma sugestão, por favor, envie um email para: <a href="mailto:bergallo.jurgen@gmail.com" className={styles.emailLink}>bergallo.jurgen@gmail.com</a>
              </Text>
